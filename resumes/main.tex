...
\subsection{Nuclear Shift Test Engineer, Portsmouth Naval Shipyard \emph{(GS-12)} \hfill 2019 -- Present}
\begin{itemize}[noitemsep]
    ...
    \item Reactor Plant Technical Branch Expert for Radiological Emergencies and Incidents
    \item Security Clearance: Active, Secret
    \item 40-hour week schedule
\end{itemize}
