...
\newcommand{\companyname}{Naval Facilities Engineering Systems Command}
% \newcommand{\companyaddress}{Company Address}
\newcommand{\companycitystatezip}{Washington Navy Yard, DC}
\newcommand{\job}{Supervisory Interdisciplinary General Engineer/Architect}
