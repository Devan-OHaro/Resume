...
\newcommand{\companyname}{Naval Facilities Engineering Systems Command (NAVFAC) Atlantic}
\newcommand{\companycitystatezip}{Patuxent River, Maryland}
\newcommand{\job}{Interdisciplinary Planner/Engineer/Architect}
